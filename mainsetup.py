...
twitch_miner = TwitchChannelPointsMiner(
    username="themisticxx",
    password="Elpepe0221x",           # If no password will be provided, the script will ask interactively
